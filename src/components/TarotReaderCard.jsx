...
function Cartomancienne() {
    return (
        ...
        >
          <Flex align="left">
            <Image src="/src/assets/img/cartomancienne.jpg" alt="Cartomancienne" boxSize="150px" borderRadius="full" mr={8} />
            <Box>
              <Heading as="h4" size="md" mb={6} textAlign={'left'} >Eva Capri</Heading>
