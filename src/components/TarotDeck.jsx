...
function TarotDeck() {
    ...
    const [animateProps, setAnimateProps] = useState(Array(cards.length).fill({ x: 0, y: 0, rotate: 0 }));
                ...
                <Box mt={10} textAlign="center">
                    ...
                    <SimpleGrid columns={3} spacing={10} mt={5}>
                        {selectedCards.map((color, index) => (
                            <Box key={index}>
                                <TarotCard backImage={backImage} frontColor={color} height="150px" width="100px" isFlipped />
